...
const VirtualTryOnWelcomePage = () => {
  return (
    <div className="w-[100vw] h-[100vh] bg-[#5C6856]">
      <div className="w-full h-full px-28 grid grid-cols-2 gap-8">
        <div className="w-full h-full col-span-1 flex flex-col gap-8 justify-center items-start">
          ...
          <button className="bg-[#FFFFFFE6] py-2 px-8 rounded-lg flex flex-row items-center justify-center text-[#323232] font-semibold text-2xl">
            Bắt đầu{" "}
            <span className="ml-4 ">
              <FiArrowRight />
            </span>

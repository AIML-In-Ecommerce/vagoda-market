...
export default function DienMayCategory() {
  ...
  const checkAllBrand = kitchenAppliances.length === checkedListBrand.length;
  const indeterminateBrand =
    checkedListBrand.length > 0 &&
    checkedListBrand.length < kitchenAppliances.length;
  ...
  const onCheckAllChangeBrand: CheckboxProps["onChange"] = (e) => {
    setCheckedListBrand(e.target.checked ? kitchenAppliances : []);
  };
  ...
  const checkAllConfiguration =
    washingMachineBrands.length === checkedConfigurationList.length;
  const indeterminate =
    checkedConfigurationList.length > 0 &&
    checkedConfigurationList.length < kitchenAppliances.length;
  ...
  const onCheckAllChangeConfiguration: CheckboxProps["onChange"] = (e) => {
    setCheckedConfigurationList(e.target.checked ? kitchenAppliances : []);
  };
